...
class Enemy():
    ...
    def __init__(self, x, y, speed, size):
        ...
        if self.type == 5:
            self.pic = pygame.image.load("assets/Helen1.png")
            self.pic2 = pygame.image.load("assets/Helen2.png")
        self.speed = speed
        self.size = size
...
player_pic2 = pygame.image.load("assets/Fish03_B.png")
player_eating_pic = pygame.image.load("assets/Fish03_open.png")

bg_animation_timer_max = 25
bg_animation_timer = bg_animation_timer_max
bg_animation_frame = 0

# Make some veriables for our player
...
player_swimming_timer_max = 16
player_swimming_timer = player_swimming_timer_max
player_swimming_frame = 0

# variebel hud (heads-up display)
score = -1
score_font = pygame.font.SysFont(
    "sitkasmallsitkatextitalicsitkasubheadingitalicsitkaheadingitalicsitkadisplayitalicsitkabanneritalic", 30)
score_text = score_font.render("Score: " + str(score), 1, (1, 1, 27))
play_button_pic = pygame.image.load("assets/BtnPlayIcon.png")
play_button_x = game_width / 2 - play_button_pic.get_width() / 2
play_button_y = game_height / 2 - play_button_pic.get_height() / 2 + 40
title_pic = pygame.image.load("assets/Title.png")
title_x = game_width / 2 - title_pic.get_width() / 2
title_y = play_button_y - 120
...
while running:
    ...
    if enemy_timer <= 0:
        ...
        if random.randint(0, 1) == 0:
            enemies.append(Enemy(-new_enemy_size * 1.25, new_enemy_y, new_enemy_speed, new_enemy_size))
        else:
    ...
    if player_alive:
        ...
        # pygame.draw.rect(screen, (11, 1, 237), player_hitbox)
    ...
    if player_alive:
        ...
        score_text = score_font.render("Final Score: " + str(score), 1, (1, 1, 27))
    if score >= 0:
